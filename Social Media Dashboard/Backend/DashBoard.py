...
app.layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src='https://github.com/Supriya-Nag/Social-Media/blob/main/linkedin%20image.png') # 150px by 45px
            ],className='mb-2'),
            dbc.Card([
                dbc.CardBody([
                    dbc.CardLink("Supriya simplylearn", target="_blank",
                                 href="https://youtube.com/Simplilearn"
                    )
                ])
            ]),
        ], width=2),
